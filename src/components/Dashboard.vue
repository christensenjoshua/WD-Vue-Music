    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-12 col-lg-6 pre-scrollable border border-dark rounded playlist-container">
          ...
          <div class="row border shadow border-light rounded text-white bg-dark text-left justify-content-between"
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="text-left row" v-for="list in userPlaylists">
              <div class="col-10">
                <button type="button" class="btn btn-secondary text-left btn-sm" style="white-space:normal;" @click="changeActiveList(list.id)"
